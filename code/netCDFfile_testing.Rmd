...
matrix_curvel_zonal_ave <- matrix_curvel_zonal %>% 
  mutate(
    X201410_ave = mean(select(matrix_curvel_zonal, starts_with("X201410"))),
    X201411_ave = mean(select(matrix_curvel_zonal, starts_with("X201411"))),
    X201412_ave = mean(select(matrix_curvel_zonal, starts_with("X201412"))),
    X201501_ave = mean(select(matrix_curvel_zonal, starts_with("X201501"))),
    X201502_ave = mean(select(matrix_curvel_zonal, starts_with("X201502"))),
    X201503_ave = mean(select(matrix_curvel_zonal, starts_with("X201503"))),
    X201504_ave = mean(select(matrix_curvel_zonal, starts_with("X201504"))),
    X201505_ave = mean(select(matrix_curvel_zonal, starts_with("X201505"))),
    X201506_ave = mean(select(matrix_curvel_zonal, starts_with("X201506"))),
    X201507_ave = mean(select(matrix_curvel_zonal, starts_with("X201507"))),
    X201508_ave = mean(select(matrix_curvel_zonal, starts_with("X201508"))),
    X201509_ave = mean(select(matrix_curvel_zonal, starts_with("X201509"))),
    X201510_ave = mean(select(matrix_curvel_zonal, starts_with("X201510"))),
    X201511_ave = mean(select(matrix_curvel_zonal, starts_with("X201511"))),
    X201512_ave = mean(select(matrix_curvel_zonal, starts_with("X201512"))),
    X201601_ave = mean(select(matrix_curvel_zonal, starts_with("X201601"))),
    X201602_ave = mean(select(matrix_curvel_zonal, starts_with("X201602"))),
    X201603_ave = mean(select(matrix_curvel_zonal, starts_with("X201603"))),
                            )
