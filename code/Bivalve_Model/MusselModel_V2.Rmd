...
mussel_odeSolve <- function(cellno, celldata, days) {
  ...
  # Interpolate using cubic spline
    Temp <- pracma::interp1(Time, Temps, T, method = "pchip")
    V <- pracma::interp1(Time, Vs, T, method = "pchip")
    mld <- pracma::interp1(Time, mlds, T, method = "pchip") 
    F_in <- pracma::interp1(Time, Fs, T, method = "pchip")
  ...
  sol <- pracma::ode23s(y0 = Init, times = Time, func = mussel_derivative, h = NULL, atol = options$abstol, rtol = options$reltol)
