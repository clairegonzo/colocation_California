...
combined <- base::merge(output_12, output_14, by = c("site", "long", "lat"), all = TRUE) %>% 
  ...
  mutate(delta = yield_14 - yield_12)
...
gg## Initial visualizations of model outputs
...
# ggsave(filename = here("figures", "aquaculture_2014_12.jpeg"), width = 8, height = 8, units = "in")
```
