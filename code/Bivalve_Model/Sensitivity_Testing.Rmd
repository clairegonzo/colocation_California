...
### Wind energy
```{r}
################ NEED TO REEXPORT THIS NOT AS A BAND ################
wind <- terra::rast(here("data", "tiff", "wind_sfunc_v1.tif"))
...
## Lat and longs not available ##
fishy <- terra::rast(here("data", "tiff", "catchdata_output_updated_.tif"))
...
ggplot(data = fishy_df, aes(x = catchdata_output_updated_)) +
  geom_histogram() +
  theme_minimal()
```
