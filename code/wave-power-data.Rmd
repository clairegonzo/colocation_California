...
```{r}
data_a10 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2010_a.csv"))
data_a89 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2008_09_a.csv"))
data_b10 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2010_b.csv"))
data_b89 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2008_09_b.csv"))
data_c10 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2010_c.csv"))
data_c89 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2008_09_c.csv"))
data_d10 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2010_d.csv"))
data_d89 <- read.csv(here("data", "wave_output", "randompoints_watts_wgs", "jupyter_data_wgs_2008_09_d.csv"))
...
data_b10_piv <- data_b10 %>% 
  pivot_longer(!time_index, names_to = "site", values_to = "watts") %>% 
  group_by(site) %>% 
  summarize(mean_watts = mean(watts, na.rm = TRUE))

data_b89_piv <- data_b89 %>% 
  pivot_longer(!time_index, names_to = "site", values_to = "watts") %>% 
  group_by(site) %>% 
  summarize(mean_watts = mean(watts, na.rm = TRUE))
...
all_b_mean <- rbind(data_b10_piv, data_b89_piv) %>% 
  group_by(site) %>% 
  summarize(mean_watts = mean(mean_watts, na.rm = TRUE))
...
points_a <- read.csv(here("random_points_wgs1984", "forR", "randompoints_wgs1984_a.csv"))
points_b <- read.csv(here("random_points_wgs1984", "forR", "randompoints_wgs1984_b.csv"))
points_c <- read.csv(here("random_points_wgs1984", "forR", "randompoints_wgs1984_c.csv"))
points_d <- read.csv(here("random_points_wgs1984", "forR", "randompoints_wgs1984_d.csv"))
```
...
wave_all_watts <- rbind(merged_a, merged_b, merged_c, merged_d) %>% 
  select(Long_wgs1984, Lat_wgs1984, mean_watts)
```

```{r}
write.csv(wave_all_watts, here("data", "wave_output", "wave_data_output_WGS.csv"))
```
